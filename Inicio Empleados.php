...
//-------------------------------
// Tabla EmpleadosCustomIncludes begin

include ("./common.php");

// Tabla EmpleadosCustomIncludes end
//-------------------------------


//-------------------------------
// Tabla EmpleadosCustomFunctions begin
...
// Tabla EmpleadosCustomFunctions end
//-------------------------------
...
//-------------------------------
$filename = "Inicio Empleados.php";
$template_filename = "Inicio Empleados.html";
//===============================



//===============================
// Inicio EmpleadosPageSecurity begin
check_security(3);
// Inicio EmpleadosPageSecurity end
//===============================

//===============================
// Inicio EmpleadosOpen Event begin
// Inicio EmpleadosOpen Event end
//===============================

//===============================
// Inicio EmpleadosOpenAnyPage Event start
// Inicio EmpleadosOpenAnyPage Event end
//===============================
...
// Inicio EmpleadosShow end

//===============================
// Inicio EmpleadosClose Event begin
// Inicio EmpleadosClose Event end
//===============================
//********************************************************************************
...
//-------------------------------
  ...
  $sDirection = "";
  $sSortParams = "";
  $sActionFileName = "Editar Empleados.php";
...
//-------------------------------
  ...
  $iSorted = get_param("Formemps_Sorted");
    ...
    switch($iSort){
    	case 1: 
		$sOrder = " order by e.nombres" . $sDirection;
		break;
    	case 2: 
...
//-------------------------------
  $sSQL = "select e.id_empleado as e_id_empleado, " . 
   "e.nombres as e_nombre " . " ," .
   "e.apaterno as e_apaterno " . " ," .   
   "e.amaterno as e_amaterno " .
   " from empleados e ";
//-------------------------------
...
//-------------------------------
    $fldemp_id_URLLink = "Editar Empleados.php";
    $fldemp_id_emp_id = $db->f("e_id_empleado");
    $fldemp_id = $db->f("e_id_empleado");
    $fldemp_edit = "Editar";    
...
//-------------------------------
      ...
      $tpl->set_var("id_empleado",$fldemp_id);
//-------------------------------------------
