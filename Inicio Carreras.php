...
//-------------------------------
// Tabla CarrerasCustomIncludes begin

include ("./common.php");

// Tabla CarrerasCustomIncludes end
//-------------------------------


//-------------------------------
// Tabla CarrerasCustomFunctions begin
...
// Tabla CarrerasCustomFunctions end
//-------------------------------
...
//-------------------------------
$filename = "Inicio Carreras.php";
$template_filename = "Inicio Carreras.html";
//===============================



//===============================
// Inicio CarrerasPageSecurity begin
check_security(2);
// Inicio CarrerasPageSecurity end
//===============================

//===============================
// Inicio CarrerasOpen Event begin
// Inicio CarrerasOpen Event end
//===============================

//===============================
// Inicio CarrerasOpenAnyPage Event start
// Inicio CarrerasOpenAnyPage Event end
//===============================
...
// Inicio CarrerasShow end

//===============================
// Inicio CarrerasClose Event begin
// Inicio CarrerasClose Event end
//===============================
//********************************************************************************
...
//-------------------------------
  ...
  $sDirection = "";
  $sSortParams = "";
  $sActionFileName = "Editar Carreras.php";
...
//-------------------------------
  $sSQL = "select e.id_carrera as e_id_carrera, " . 
...
//-------------------------------
    $fldemp_id_URLLink = "Editar Carreras.php";
    $fldemp_id_emp_id = $db->f("e_id_carrera");
    $fldemp_id = $db->f("e_id_carrera");
    $fldemp_edit = "Editar";    
...
//      $tpl->set_var("emp_amaterno", tohtml($fldemp_amaterno));
      $tpl->set_var("id_carrera",$fldemp_id);
//-------------------------------------------
